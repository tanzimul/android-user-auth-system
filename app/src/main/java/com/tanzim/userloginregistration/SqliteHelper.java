...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void addUser(User user) {
        ...
        //Put date in @values
        values.put(KEY_TODAY, user.today);
    ...
    public User Authenticate(User user) {
        ...
        Cursor cursor = db.query(TABLE_USERS,// Selecting Table
                new String[]{KEY_ID, KEY_USER_NAME, KEY_EMAIL, KEY_PASSWORD, KEY_TODAY},//Selecting columns want to query
                KEY_EMAIL + "=?",
    ...
    public ArrayList<HashMap<String, String>> GetUsers(){
        ...
        String query = "SELECT userName, email, today FROM "+ TABLE_USERS;
        ...
        while (cursor.moveToNext()){
            ...
            user.put("today",cursor.getString(cursor.getColumnIndex(KEY_TODAY)));
            userList.add(user);
        }
        return  userList;
    }
